...
pub use artifact::{
    ...
    GeoMatchHeader, GeoMatchHeaderPage, GeoPayload, GeoPayloadHeader, open_geo_index,
...
pub use packed_spatial_index::{
    ...
    StreamIndex2DF32, StreamIndex3D, StreamIndex3DF32, StreamLimits, haversine_distance_2d,
    read_metadata,
};
